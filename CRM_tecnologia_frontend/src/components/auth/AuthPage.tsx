...
export const AuthPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Usar flush microtask (Promise.resolve) para evitar el setState sincrónico en effect
    let cancelled = false;
    Promise.resolve()
      .then(() => {
        if (cancelled) return;
        ...
        <div className="inv-modal-overlay" onClick={closeInviteFlow}>
          <div className="inv-modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="inv-modal-header">
              ...
              <button type="button" className="inv-modal-close-btn" onClick={closeInviteFlow}>
                ✕
              </button>
            </div>
            ...
            {isValidatingInvite ? (
              ...
              <form onSubmit={handleInviteRegisterSubmit} className="inv-modal-form">
                ...
                <div className="inv-modal-note">
                  <Clock size={14} />
                  <span>
                    Al confirmar tu OTP, tu registro quedará completado y entrarás en estado <strong>En espera de habilitación</strong> hasta que el Administrador autorice tu acceso.
                  </span>
                </div>

                <div className="inv-modal-actions">
                  <button type="button" className="inv-btn-secondary" onClick={closeInviteFlow}>
                    Cancelar
                  </button>
